...
# =============================================================================
# PURPOSE:
#   UserPromptSubmit hook that detects when /session-memory-refresh is invoked
...
#   2. Checks if the prompt contains "session-memory-refresh" trigger
